...
public class GeoLocationController extends FragmentActivity implements ConnectionCallbacks, OnConnectionFailedListener, LocationListener, OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geo_location_test);
    ...
    public void sendLatLongToMainActivity(View view){

        Intent GeoData = new Intent();
        GeoData.putExtra("Latitude",mCurrentLocation.getLatitude());
        GeoData.putExtra("Longitude",mCurrentLocation.getLongitude());
        setResult(Activity.RESULT_OK, GeoData);
        finish();
    }
}
